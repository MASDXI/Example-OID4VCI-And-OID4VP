...
export class HolderController {
    ...
    async resolveCredentialOffer(@Body() body, @Res() res) {
        ...
        try {
            const metadata = await this.holderService.resolveCredentialOffer(payload, address);
    ...
    async acceptCredentialOffer(@Body() body, @Res() res) {
        ...
        try {
            const prettyClaims = await this.holderService.acceptCredentialOffer(address, credentialOfferId);
    ...
    async getCredential(@Param() params, @Res() res) {
        try {
            const { id, address } = params;
            const credential = await this.holderService.getCredentialByAddress(id, address);
